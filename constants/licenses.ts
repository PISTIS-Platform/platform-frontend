export const licenses = [
    ...
    {
        code: 'CC_BYSA_3_0',
        label: 'Creative Commons Attribution–ShareAlike 3.0 Unported',
        description:
            'CC BY-SA 3.0 lets others remix, tweak, and build upon the author’s work even for commercial purposes, as long as they credit the author and licence their new creations under the identical terms. This licence is often compared to “copyleft” free and open source software licences. All new works based on the original work will carry the same licence, so any derivatives will also allow commercial use. This is the licence used by Wikipedia, and is recommended for materials that would benefit from incorporating content from Wikipedia and similarly licenced projects.',
    },
    {
        code: 'CC_BYND_3_0',
        label: 'Creative Commons Attribution–NoDerivs 3.0 Unported',
        description:
    ...
    {
        code: 'CC_BYNC_3_0',
        label: 'Creative Commons Attribution–NonCommercial 3.0 Unported',
        description:
    ...
    {
        code: 'CC_BYNCSA_3_0',
        label: 'Creative Commons Attribution–NonCommercial–ShareAlike 3.0 Unported',
        description:
    ...
    {
        code: 'CC_BYNCND_3_0',
        label: 'Creative Commons Attribution–NonCommercial–NoDerivs 3.0 Unported',
        description:
    ...
    {
        code: 'CC_BYSA_2_0',
        label: 'Creative Commons Attribution–ShareAlike 2.0 Generic',
        description:
            'CC BY-SA 2.0 lets others remix, tweak, and build upon the author’s work even for commercial purposes, as long as they credit the author and licence their new creations under the identical terms. This licence is often compared to “copyleft” free and open source software licences. All new works based on the original work will carry the same licence, so any derivatives will also allow commercial use. This is the licence used by Wikipedia, and is recommended for materials that would benefit from incorporating content from Wikipedia and similarly licenced projects.',
    },
    {
        code: 'CC_BYND_2_0',
        label: 'Creative Commons Attribution–NoDerivs 2.0 Generic',
        description:
    ...
    {
        code: 'CC_BYNC_2_0',
        label: 'Creative Commons Attribution–NonCommercial 2.0 Generic',
        description:
    ...
    {
        code: 'CC_BYNCSA_2_0',
        label: 'Creative Commons Attribution–NonCommercial–ShareAlike 2.0 Generic',
        description:
    ...
    {
        code: 'CC_BYNCND_2_0',
        label: 'Creative Commons Attribution–NonCommercial–NoDerivs 2.0 Generic',
        description:
    ...
    {
        code: 'CC_BYNCND_1_0',
        label: 'Creative Commons Attribution–NoDerivs–NonCommercial 1.0 Generic',
        description:
    ...
    {
        code: 'CC_BYSA_2_5',
        label: 'Creative Commons Attribution–ShareAlike 2.5 Generic',
        description:
            'CC BY-SA 2.5 lets others remix, tweak, and build upon the author’s work even for commercial purposes, as long as they credit the author and licence their new creations under the identical terms. This licence is often compared to “copyleft” free and open source software licences. All new works based on the original work will carry the same licence, so any derivatives will also allow commercial use. This is the licence used by Wikipedia, and is recommended for materials that would benefit from incorporating content from Wikipedia and similarly licenced projects.',
    },
    {
        code: 'CC_BYND_2_5',
        label: 'Creative Commons Attribution–NoDerivs 2.5 Generic',
        description:
    ...
    {
        code: 'CC_BYNC_2_5',
        label: 'Creative Commons Attribution–NonCommercial 2.5 Generic',
        description:
    ...
    {
        code: 'CC_BYNCSA_2_5',
        label: 'Creative Commons Attribution–NonCommercial–ShareAlike 2.5 Generic',
        description:
    ...
    {
        code: 'CC_BYNCND_2_5',
        label: 'Creative Commons Attribution–NonCommercial–NoDerivs 2.5 Generic',
        description:
    ...
    {
        code: 'EUPL_1_0',
        label: 'European Union Public Licence v.1.0',
        description:
    ...
    {
        code: 'EUPL_1_1',
        label: 'European Union Public Licence v. 1.1',
        description:
    ...
    {
        code: 'EUPL_1_2',
        label: 'European Union Public Licence v. 1.2',
        description:
    ...
    {
        code: 'CC_BYNCND_4_0',
        label: 'Creative Commons Attribution–NonCommercial–NoDerivs 4.0 International',
        description:
    ...
    {
        code: 'CC_BYND_4_0',
        label: 'Creative Commons Attribution–NoDerivs 4.0 International',
        description:
    ...
    {
        code: 'CC_BYSA_3_0_NL',
        label: 'Creative Commons Attribution-ShareAlike 3.0 Netherlands',
        description:
    ...
    {
        code: 'DLDE_BYNC_1_0',
        label: 'Data licence Germany – attribution – non-commercial – Version 1.0',
        description:
    ...
    {
        code: 'DLDE_BY_1_0',
        label: 'Data licence Germany – attribution – Version 1.0',
        description:
    ...
    {
        code: 'DLDE_ZERO_2_0',
        label: 'Data licence Germany – Zero – Version 2.0',
        description:
    ...
    {
        code: 'HROD',
        label: 'Open Licence – The Republic of Croatia',
        description:
    ...
    {
        code: 'IODL_1_0',
        label: 'Italian Open Data License v1.0',
        description:
    ...
    {
        code: 'IODL_2_0',
        label: 'Italian Open Data License v2.0',
        description:
    ...
    {
        code: 'NLOD_1_0',
        label: 'Norwegian Licence for Open Government Data 1.0',
        description:
    ...
    {
        code: 'OGL_NC',
        label: 'Non-Commercial Government Licence 1.0',
        description:
    ...
    {
        code: 'PSEUL',
        label: 'EU INSPIRE End User Licence',
        description:
    ...
    {
        code: 'CECILL_2_1',
        label: 'CEA CNRS Inria Free Software License Agreement, v2.1 (CECILL-2.1)',
        description:
    ...
    {
        code: 'EPL_2_0',
        label: 'Eclipse Public License version 2.0',
        description:
    ...
    {
        code: 'EFL_2',
        label: 'Eiffel Forum License, version 2',
        description: 'EFL-2.0 is a BSD-style, permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'ENTESSA',
    ...
    {
        code: 'LPPL_1_3C',
        label: 'LaTeX Project Public License v1.3c (LPPL-1.3c)',
        description:
    ...
    {
        code: 'BSD_3_CLAUSE_LBNL',
        label: 'Lawrence Berkeley National Labs BSD Variant License (BSD-3-Clause-LBNL)',
        description:
            'BSD-3-Clause-LBNL is a BSD-style, permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'LILIQ_P_1_1',
        label: 'Québec Free and Open-Source Licence – Permissive (LiLiQ-P) version 1.1',
        description:
            'Approved by the Open Source Initiative, LiLiQ-P-1.1 is a permissive licence produced by the State of Quebec (Canada).',
    },
    {
        code: 'LILIQ_R_1_1',
        label: 'Québec Free and Open-Source Licence – Reciprocity (LiLiQ-R) version 1.1',
        description:
    ...
    {
        code: 'LILIQ_RPLUS_1_1',
        label: 'Québec Free and Open-Source Licence – Strong Reciprocity (LiLiQ-R+) version 1.1',
        description:
    ...
    },
    {
        ...
        description: 'MS-PL is a BSD-style, permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'MS_RL',
        label: 'Microsoft Reciprocal License (MS-RL)',
        description: 'MS-RL is a copyleft-style, free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'MIROS',
        label: 'MirOS License (MirOS)',
        description: 'MirOS is a BSD-style, permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'MIT',
    ...
    {
        code: 'MOTOSOTO',
        label: 'Motosoto Open Source License – Version 0.9.1 (Motosoto)',
        description: 'Motosoto is a copyleft-style, free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'MPL_2_0',
        label: 'Mozilla Public License (MPL), version 2.0 (MPL-2.0)',
        description:
    ...
    {
        code: 'NPOSL_3_0',
        label: 'The Non-Profit Open Software License version 3.0 (NPOSL-3.0)',
        description:
    ...
    {
        code: 'OGTSL',
        label: 'The Open Group Test Suite License (OGTSL)',
        description:
    ...
    {
        code: 'OSL_3_0',
        label: 'Open Software License, version 3.0 (OSL-3.0)',
        description:
    ...
    {
        code: 'PHP_3_0',
        label: 'The PHP License 3.0 (PHP-3.0)',
        description:
    ...
    {
        code: 'POSTGRE_SQL',
        label: 'The PostgreSQL Licence (PostgreSQL)',
        description:
            'PostgreSQL is a BSD-style permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'PYTHON_2_0',
        label: 'Python License (Python-2.0)',
        description: 'Python 2.0 is a permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'CNRI_PYTHON',
        label: 'The CNRI portion of the multi-part Python License (CNRI-Python)',
        description: 'CNRI-Python is a permissive free software licence approved by the Open Source Initiative.',
    },
    {
        code: 'QPL_1_0',
    ...
    {
        code: 'UPL_1_0',
        label: 'The Universal Permissive License (UPL), Version 1.0',
        description:
    ...
    {
        code: 'W3C',
        label: 'The W3C Software Notice and License (W3C)',
        description:
    ...
    {
        code: '0BSD',
        label: 'Zero-Clause BSD / Free Public License 1.0.0 (0BSD)',
        description:
    ...
    {
        code: 'ZPL_2_0',
        label: 'The Zope Public License Version 2.0 (ZPL-2.0)',
        description:
    ...
    },
    {
        ...
        description:
            'GNU FDL 1.3 is a form of copyleft intended for use on a manual, textbook or other document to assure everyone the effective freedom to copy and redistribute it, with or without modifications, either commercially or non-commercially. Incompatible with later GFDL licence versions.',
    },
    {
        code: 'CLARIN_ACA_1_0',
        label: 'Clarin Academic End-User Licence (ACA) 1.0',
        description:
    ...
    {
        code: 'ETALAB_2_0',
        label: 'Etalab Open Licence V 2.0',
        description:
    ...
    {
        code: 'EUROGEO_2022',
        label: 'EuroGeographics Open Data Licence v.2022',
        description:
    ...
    {
        code: 'BSD_3_CLAUSECLEAR',
        label: 'BSD 3-Clause Clear License',
        description:
            'BSD-3-Clause Clear permits redistribution and use in source and binary forms, with or without modification, provided that the certain conditions are met: redistributions of source code and in binary forms must retain the copyright notice, the specific list of conditions and the disclaimer. Neither the name of the copyright holder nor of its contributors may be used to promote derived products without prior written permission. As additional protection, BSD 3 Clause Clear, unlike BSD 3, states that it does not allow express or implied licences to any party’s patent rights.',
    },
    {
        code: 'GPL_3_0_OR_LATER',
        label: 'GNU General Public License v3.0 or later',
        description:
            'GPL-3.0 was forged in 2007. It is a copyleft licence. OSI states GPL (without indicating version number) as supported by a strong community (the Free Software Fundation - FSF). You may copy, distribute and modify the software as long as you track changes/dates in source files. Any derivative including (i.e. via compiler) GPL-licensed code must also be made available under the GPL-3.0 along with build & install instructions.',
    },
    {
        code: 'GPL_2_0_OR_LATER',
        label: 'GNU General Public License v2.0 or later',
        description:
            'Covers both the GPL-2.0 (the ‘historical’ free software license), the GPL-3.0 and possible later versions. Supported by a strong community (the Free Software Foundation - FSF). Copy, modification and distribution authorised. Changes/dates must be traced in source files. Any derivative must also be made available under one or more of these GPL versions.',
    },
    {
        code: 'GNU_FDL_1_3_OR_LATER',
        label: 'GNU Free Documentation License v1.3 or later',
        description:
            'GNU FDL 1.3 is a form of copyleft intended for use on a manual, textbook or other document to assure everyone the effective freedom to copy and redistribute it, with or without modifications, either commercially or non-commercially. Compatible with later GFDL licence versions.',
    },
    {
        code: 'AFL_3_0',
        label: 'Academic Free License v3.0',
        description:
            "Written by Lawrence Rosen, AFL-3.0 gives recipients a copyright and allows for a patent on the software so long as they include the original software, any of its copyrights or trademarks and a note saying that you modified it. Nearly identical as the Open Software License, but not reciprocal: it is permissive, interoperable and doesn't force derivative works to use the same licence.",
    },
    {
        code: 'CECILL_C_1_0',
    ...
    {
        code: 'LGPL_2_1_OR_LATER',
        label: 'GNU Lesser General Public License v2.1 or later',
        description:
            'The Free Software Foundation (FSF) produced LGPL for libraries. Works made by using the covered software could be distributed under any licence. Distribution of derivatives (after code modification) must be done under LGPL. Reverse engineering must be allowed (= a general permission in EU law). FSF assimilates static linking to producing derivatives (which may not be the case under EU law). GLPL-2.1-or later is compatible with later GLPL versions.',
    },
    {
        code: 'AGPL_3_0_OR_LATER',
        label: 'GNU Affero General Public License v3.0 or later',
        description:
            "AGPL-3.0 is A modified GPL-3.0 extended to network or Web services distribution (SaaS). Similar to the EUPL on that point. The licence is copyleft: copies and derivatives may be distributed under the same AGPL only. Need to document derivatives' changes and dates. AGPL-3.0-or later is compatible with later AGPL versions.",
    },
    {
        code: 'DFSL_1_0',
        label: 'German Free Software License',
        description:
            'D-FSL-1.0 is a GPL-compatible open source license. It is tailored to German and European law and therefore differs from previous free software licenses. The D-FSL is written in German and English. It is binding in both versions and is therefore also suitable for international use.',
    },
    {
        code: 'UNLICENCE',
        label: 'The Unlicense',
    ...
    {
        code: 'LGPL_3_0_OR_LATER',
        label: 'GNU Lesser General Public License v3.0 or later',
        description:
            'The Free Software Foundation (FSF) produced LGPL for libraries. Works made by using the covered software could be distributed under any licence. Distribution of derivatives (code modifications) must be done under LGPL. Reverse engineering must be allowed (= a general permission in EU law). FSF assimilates static linking to producing derivatives (which is not the case in EU law when made for interoperability). GLPL-3.0-or later is compatible with later GLPL versions.',
    },
    {
        code: 'EUROGEO_2024',
        label: 'EuroGeographics Open Data Licence v.2024',
        description:
            'Open data license approved by the members of EuroGeographics AISBL. This license allows end users to access and use the data, as long as accreditation is provided and that derived datasets are not licensed under any additional and different conditions.',
    },
    {
        code: 'OGL_NC_2_0',
        label: 'Non-Commercial Government Licence 2.0',
        description:

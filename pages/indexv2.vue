    ...
    <div class="w-full h-screen bg-white">
        ...
        >
            <div class="flex flex-col gap-2 justify-start">
                <img v-if="orgLogo" class="w-20 h-12" :src="`/img/${orgLogo}`" alt="Pistis Organisation Logo" />
            </div>
            ...
            <NuxtLink
                ...
                :to="'/home/'"
                class="rounded-md border border-primary-600 text-primary-600 text-base hover:border hover:bg-primary-600 hover:text-white py-2 px-4 transition-all"
                >Home</NuxtLink
            >
        </nav>
        ...
        >
            <div class="relative flex flex-col items-center sm:items-start justify-center space-y-6">
                <img class="h-12 w-52" src="/img/PISTIS_logo.png" alt="PISTIS logo" />
